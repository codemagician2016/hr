...
//   1. Add it to SECTORS in platform/lib/professions.js
//   2. If a theme matches the vibe, add a row below.
//   3. If no theme matches, leave it out — it'll fall back to 'other'
//      which is a neutral starter look.
...
const CATEGORY_TO_THEME = {
  ...
  'vitamins-subscription': 'subscription',
  'luxury-boutique':   'luxe',
  'luxury-fashion':    'luxe',
  'fine-jewellery':    'luxe',
  'designer-boutique': 'luxe',
  'haute-couture':     'luxe',
  'quick-commerce':    'quick',
  'q-commerce':        'quick',
  'instant-delivery':  'quick',
  'instant-grocery':   'quick',
  'dark-store':        'quick',
  '10-minute-delivery': 'quick',
};
...
function getThemeForCategory(profession) {
...
function getCategoriesForTheme(themeKey) {
