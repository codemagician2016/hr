...
//
// Mirror copies live at backend/src/lib/vertical.js and business/lib/vertical.js
// because vertical isolation forbids cross-app imports. Update all three
// when the default changes.

export const DEFAULT_VERTICAL = 'APPOINTMENT';
export const VALID_VERTICALS = new Set(['STATIC', 'APPOINTMENT', 'ECOMMERCE']);

export function resolveVertical(value) {
